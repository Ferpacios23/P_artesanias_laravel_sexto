                        ...
                        <div class="card mb-4">
                            ...
                            <table class="table">
                                <!-- < id="datatablesSimple"> -->
                                    ...
                                    $conexion=mysqli_connect("localhost","root","","p_artesanias");               
                                    ...
                                    <td>
                                    <a  class="btn btn-warning" href="./crud/editar.php ?id=<?php echo $fila['id']?>   ">Editar </a>

                                    <a class="btn btn-danger" href="./crud/eliminar.php ?id=<?php echo $fila['id']?>   ">Eliminar</a>                                    
                                    </td>
                                    </tr>
