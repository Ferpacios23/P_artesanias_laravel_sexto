		...
		<main class="main-content">
				...
				<div class="container-products">
					...
					<div class="card-product">
						<div class="container-img">
							<img src="img/joyeria(1).jpg" alt="aretes estilo sol 4 colores" />
					...
					<div class="card-product">
						<div class="container-img">
							<img
								src="img/joyeria(2).jpg"
								alt="aretes tipo candongas"
							/>
					...
					<div class="card-product">
						<div class="container-img">
							<img
								src="img/joyeria(3).jpg"
								alt="collar multi colores"
							/>
							<div class="button-group">
								<span>
									<i class="fa-regular fa-eye"></i>
					...
					<div class="card-product">
						<div class="container-img">
							<img src="img/joyeria(4).jpg" alt="collar negro, rojo, amerillo, azul" />
							<div class="button-group">
								<span>
									<i class="fa-regular fa-eye"></i>
								</span>
			...
			<section class="container specials">
				...
				<div class="container-products">
					...
					<div class="card-product">
						<div class="container-img">
							<img src="img/bolsos(1).jpg" alt="bolso tejido" />
							<span class="discount">-13%</span>
							<div class="button-group">
								<span>
									<i class="fa-regular fa-eye"></i>
					...
					<div class="card-product">
						<div class="container-img">
							<img src="img/joyeria(5).jpg" alt="collar chocoano" />
					...
					<div class="card-product">
						<div class="container-img">
							<img src="img/joyeria(2).jpg" alt="aretes tipo candongas" />
							<div class="button-group">
								<span>
									<i class="fa-regular fa-eye"></i>
								</span>
			...
			<section class="container blogs">
				...
				<div class="container-blogs">
					<div class="card-blog">
						<div class="container-img">
							<img src="img/blogs.jpg" alt="Imagen Blog 1" />
					...
					<div class="card-blog">
						<div class="container-img">
							<img src="img/blogs(1).jpg" alt="Imagen Blog 2" />
							<div class="button-group-blog">
								<span>
									<i class="fa-solid fa-magnifying-glass"></i>
								</span>
					...
					<div class="card-blog">
						<div class="container-img">
							<img src="img/blogs(2).jpg" alt="Imagen Blog 3" />
							<div class="button-group-blog">
								<span>
									<i class="fa-solid fa-magnifying-glass"></i>
								</span>
